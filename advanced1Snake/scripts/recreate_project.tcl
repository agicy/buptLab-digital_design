...
set files [list \
  [list "${origin_dir}/src/ip/clock_generator/clock_generator.xci" "XCI"] \
  [list "${origin_dir}/src/ip/food_image_rom/food_image_rom.xci" "XCI"] \
  [list "${origin_dir}/src/ip/head_image_happy_rom/head_image_happy_rom.xci" "XCI"] \
  [list "${origin_dir}/src/ip/head_image_lose_rom/head_image_lose_rom.xci" "XCI"] \
  [list "${origin_dir}/src/ip/head_image_normal_rom/head_image_normal_rom.xci" "XCI"] \
  [list "${origin_dir}/src/ip/startup_image_rom/startup_image_rom.xci" "XCI"] \
  [list "${origin_dir}/src/hdl/config.svh" "Verilog Header"] \
  [list "${origin_dir}/../util/combinational/segment_decoder.sv" "SystemVerilog"] \
  [list "${origin_dir}/../util/sequential/counter.sv" "SystemVerilog"] \
  ...
  [list "${origin_dir}/../module/lcd_screen_signal_generator.sv" "SystemVerilog"] \
  ...
  [list "${origin_dir}/src/hdl/controller/random_engine.sv" "SystemVerilog"] \
  [list "${origin_dir}/src/hdl/controller/snake_modifier.sv" "SystemVerilog"] \
  [list "${origin_dir}/src/hdl/controller/state_machine.sv" "SystemVerilog"] \
  [list "${origin_dir}/src/hdl/top_module.sv" "SystemVerilog"] \
  [list "${origin_dir}/src/coe/food.coe" "COE"] \
  [list "${origin_dir}/src/coe/head_happy.coe" "COE"] \
  [list "${origin_dir}/src/coe/head_lose.coe" "COE"] \
  [list "${origin_dir}/src/coe/head_normal.coe" "COE"] \
  [list "${origin_dir}/src/coe/startup.coe" "COE"] \
]
